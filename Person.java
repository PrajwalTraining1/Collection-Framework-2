...
public class Assignment5Q1 {
    public static void main(String[] args) {
        ...
        set.add(new Person("Pajwal",165,70.5));
        set.add(new Person("Ritik",167,63.8));
        set.add(new Person("Pratik",172,80.9));
        set.add(new Person("Ujjwal",162,50.5));
        set.add(new Person("Harsh",170,50.5));
        set.add(new Person("Atharva",162,51.5));
        set.add(new Person("Aryan",162,53.5));
